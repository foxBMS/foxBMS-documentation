...
+---------------------+----------------+---------+---------------+-----------------------------------+
| CANS_MSG_BMS10      | 0x554 (1364)   | 8       | TX            | Insulation/Balancing              |
+---------------------+----------------+---------+---------------+-----------------------------------+
...
| **Signal name**               | **Start bit**         | **Bit length** | **Multiplexed** | **Factor** | **Offset** | **Min** | **Max**    | **Byteorder** |
+-------------------------------+-----------------------+----------------+-----------------+------------+------------+---------+------------+---------------+
| BMS10_Insulation_Good         | 0                     | 1              | False           | 1.0        | 0.0        | 0.0     | 1.0        | Intel         |
+-------------------------------+-----------------------+----------------+-----------------+------------+------------+---------+------------+---------------+
| BMS10_Insulation_Value        | 1                     | 7              | False           | 1.0        | 0.0        | 0.0     | 127.0      | Intel         |
+-------------------------------+-----------------------+----------------+-----------------+------------+------------+---------+------------+---------------+
...
The signals presented in the previous table are for the peripheral functions of the battery system, namely the insulation monitoring device, the balancing and the self testing capabilities. The insulation monitoring values are sent over CAN while the balancing feedback values are not. The signals ``BMS10_Selftest_state`` and ``BMS10_Selftest_Debug`` are left open for custom developments.
