...
This section describes the checksum feature in |foxbms|. For the toolchain/buildprocess of the checksum feature, see :ref:`software_documentation_checksum_tool`.
...
Related Modules
~~~~~~~~~~~~~~~
The checksum tool is related on the ``Checksum Tool`` configuration (see :ref:`software_documentation_checksum_tool`).
