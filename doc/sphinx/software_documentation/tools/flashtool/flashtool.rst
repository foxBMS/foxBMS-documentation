...
With the command line tool you can program the flash memory of the foxBMS (or generally STM32F4) microcontroller with a binary file. Also a dump read or a full erase of the flash memory can be done.
...
#. Connect the USB slot of the primary or secondary microcontroller to your computer.

#. Check to which serial interface it is connected (Windows: COMxx, Linux: /dev/ttyUSBx)

#. You can call the tool from the commandline:
